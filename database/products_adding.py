...
class ProductManager:
    ...
    products = [
        ...
        Product("Wallet", "compact leather holder", 50, 2, 1, "wallet.JPEG"),
        Product("Mug", "ceramic coffee mug", 50, 2, 1, "Mug.JPEG"),
        Product("Purse", "slim zip pouch", 50, 2, 1, "purse.JPEG"),
        Product("Bear", "soft plush toy", 50, 2, 1, "bearq.JPEG"),
        Product("Keychain", "small decorative keys", 50, 2, 1, "keychain.JPEG"),
        Product("Cap", "casual sports cap", 50, 2, 1, "Cap.JPEG"),
        Product("EJUST T-shirt", "cotton shirt with EJUST written on it", 50, 2, 1, "EJUST tshirt.JPEG"),
        Product("Ring", "elegant gemstone ring", 50, 2, 1, "ring.JPEG"),
        Product("Necklace", "delicate silver chain", 50, 2, 1, "necklace.JPEG"),
        Product("Box", "decorative gift box", 50, 2, 1, "Box.JPEG"),        
